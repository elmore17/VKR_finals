    ...
    <div class="container mx-auto mt-7 grid grid-cols-3 gap-8">
            ...
            <div class="grid grid-cols-2 gap-5 max-w-3xl">
                <div class="mt-5">
                    <div class="border max-w-96 h-28 pl-5 pt-5 rounded-t-xl colorboxinfo">
                        ...
                        <input datepicker datepicker-buttons datepicker-autoselect-today ref="datepickerRef"  type="text" class="bg-none border-dashed containercolorinfo text-sm rounded-3xl block w-44 h-7 ps-10 p-2.5 border-collapse" placeholder="Выберете дату">
                        </div>
                    </div>
        ...
        <div>
            ...
            <div class="overflow-auto border rounded-b-xl colorboxbottom max-h-60">
                <div class=" h-11 pl-5 pt-2 hover:bg-gray-900 rounded-b-xl">
...
import ru from "../../node_modules/flowbite-datepicker/js/i18n/locales/ru"
...
export default{
    ...
    mounted(){
        ...
        new Datepicker(this.$refs.datepickerRef, datepickerOptions)
    }
}
</script>
